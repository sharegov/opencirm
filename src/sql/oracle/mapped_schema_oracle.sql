...
create index CIRM_IDX_ACTIVITY_SR_ID ON CIRM_SR_ACTIVITY(SR_REQUEST_ID) INITRANS 100;-- COMPUTE STATISTICS ONLINE;
...
create index CIRM_IDX_SR_REQUEST_CASE_NUM on CIRM_SR_REQUESTS(UPPER(CASE_NUMBER)) INITRANS 100;
