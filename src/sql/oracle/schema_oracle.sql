   ...
   create table CIRM_IRI_TYPE (
	...
	--Missing indices
	create index CIRM_IDX_CLASS_TO_OWLC_SUBJ on CIRM_CLASSIFICATION(TO_DATE, OWLCLASS, SUBJECT) INITRANS 10;
	create index CIRM_IDX_CLASSIFICATION_CLASS on CIRM_CLASSIFICATION(OWLCLASS) INITRANS 100; --drop later
