...
public class RestServiceAdmin extends RestService {
    /**
     * <p>
     * Return general information about the server and JVM the platform is running on.
     * </p>
     */
    @GET
    @Path("/sysinfo")
    ...
    // (JaxRsApplication) StartUp.getServer().getDefaultHost().getApplication();
    ...
    public Json applicationUpdated() {
        ...
        EventDispatcher.get().dispatch(OWL.individual("CIRMApplication"),
                OWL.owlClass("Software_Application"), null, OWL.individual("BO_Update"));
        return ok();
    }
}
