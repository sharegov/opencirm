...
/**
 * Use AnswerResolverDatePlus90Days to add 90 days to each detected date or datetime.
 * 
 * @author Thomas Hilpold
 *
 */
public class AnswerResolverDatePlus90Days implements VariableResolver {

	private AnswerResolver answerResolver;

	public AnswerResolverDatePlus90Days() {
		DateModifier datePlus90 = new DateModifier() {
		...
		answerResolver = new AnswerResolver(datePlus90);
	}
