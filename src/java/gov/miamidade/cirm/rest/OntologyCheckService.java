...
/**
 * Rest Service class to assist with manual tasks
 * such as maintaining a current list of county departments 
 * in the ontology and checking that all SRs have a providedBy.
 * 
 * @author Syed
 *
 */
...
public class OntologyCheckService
{
	...
	public Json checkCountyDepartments()
	{
		DepartmentConsistencyChecker checker = new DepartmentConsistencyChecker();
		return GenUtils.ok().set("isConsistentWithPayroll", checker.isOntologyConsistentWithPayroll());
	}
